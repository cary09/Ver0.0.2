...
:: Android packaging
set AND_CERT_NAME="MatchGame"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\MatchGame.p12
...
set IOS_PROVISION=cert\MatchGame.mobileprovision
...
set APP_ID=air.MatchGame

:: Output packages
set DIST_PATH=dist
set DIST_NAME=MatchGame

:: Debugging using a custom IP
set DEBUG_IP=192.168.0.10
